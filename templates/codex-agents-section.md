...
Route freeform workflow requests through `codex-gstack-router`, which should run `$HOME/.codex/gstack-macos/bin/gstack-workflow-dispatch --repo <target-repo> --input "<user request>"`.
