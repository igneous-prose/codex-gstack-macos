...
2. If `planPath` is present, read `docs/gstack/<initiative-id>/plan.md` and validate the current implementation against the saved acceptance criteria.
3. If `planPath` is missing, say you are falling back to installation and branch-only verification.
